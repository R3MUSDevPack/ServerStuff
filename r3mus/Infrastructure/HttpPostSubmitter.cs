...
{
    public class HttpPostSubmitter
    {
        /// <summary>
        ...
        public HttpPostSubmitter(string url):this()
        {
            m_url=url;
        }
        ...
        public HttpPostSubmitter(string url, NameValueCollection values)
            : this(url)
        {
            m_values=values;
        }
